...
<<<<<<< HEAD
    ...
    path('students/<int:student_id>/<int:pk>/renew',
         RenewStudentBookView.as_view(), name='renew-book'),
    path('students/<int:pk>/edit', StudentEditProfile.as_view(),
         name='edit_student_profile'),

    path('register_staff/', Register_staff.as_view(), name='register_staff'),
    path('staff/<int:staff_id>/', StaffDetailView,
         name='staffprofile'),
    path('staff_book/<int:staff_id>/', new_staff_book, name='new_staff_book'),
    path('staff/<int:staff_id>/<int:pk>/delete',
         StaffBookDelete.as_view(), name='delete_staff_book'),
    path('staff/<int:staff_id>/<int:pk>/renew',
